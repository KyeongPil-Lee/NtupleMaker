...
FileName = ""
if isMC == True:
  FileName = "file:/u/user/kplee/scratch/ROOTFiles_Test/80X/ExampleMiniAODv2_ZMuMuPowheg_M50to120_ReHLT.root"
else:
...
# -- condition for reHLT sample -- #
process.recoTree.processName = cms.untracked.string("HLT2")
process.recoTree.TriggerResults = cms.untracked.InputTag("TriggerResults", "", "HLT2")
