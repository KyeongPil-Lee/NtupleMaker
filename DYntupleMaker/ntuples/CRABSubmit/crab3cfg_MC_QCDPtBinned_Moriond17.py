...
if __name__ == '__main__':
    ...
    #############################
    # -- inclusive -- #
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt20toInf'
    ...
    # -- Pt-binned -- #
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt15to20'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt20to30'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt30to50'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt50to80'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt80to120'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt80to120_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt120to170'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt120to170_backup'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt170to300'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt170to300_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt170to300_backup'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt300to470'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt300to470_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt300to470_ext2'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt470to600'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt470to600_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt470to600_ext2'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt600to800'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt600to800_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt600to800_backup'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt800to1000'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt800to1000_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt800to1000_ext2'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt1000toInf'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDMuEnriched_Pt1000toInf_ext1'
    ...
    #############################
    # -- inclusive -- #
    # config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt20toInf'
    # config.Data.inputDataset = ''
    # crabCommand('submit', config = config)

    # -- Pt-binned -- #
    # config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt15to20'
    # config.Data.inputDataset = ''
    # crabCommand('submit', config = config)

    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt20to30'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt30to50'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt30to50_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt50to80'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt50to80_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt80to120'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt80to120_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt120to170'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt120to170_ext1'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt170to300'
    ...
    config.General.requestName = 'DYntuple'+version+'QCDEMEnriched_Pt300toInf'
